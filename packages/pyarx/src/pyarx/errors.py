...
summary: >-
  ...
  programmatically instead of scraping message text. The pipeline modules
  catch upstream arx and irx exceptions and re-raise them as these types,
  building diagnostics via the helpers in pyarx.diagnostics.
"""
...
class CompileError(ArxError):
    """
    title: Raised when semantic analysis, lowering, native compile, or
      linking fails.
    description: >-
